...
const TEXT = {
  ...
  'ui.beats':     n => n + ' 拍',
  'score.title':  '簡譜',
  'score.hint':   '演奏時跟著亮；數字上方的點＝高八度，下方的點＝低八度（覺得太低就看點在哪裡，用混音師面板的「移調半音」整首搬上去）',
  'score.empty':  '按任何一首開始演奏，這裡就會跟著顯示簡譜',
  'jp.radix':     '進位',
  'jp.radix10':   '10 進位',
  'jp.radix16':   '16 進位',
  'jp.hexScale':  '音階梯',
  ...
  'jp.hex':       'DEADBEEF',
  'jp.title':     '簡譜即興台',
  'jp.hint':      '1–7 音級、0 休止、- 延長、. 附點、/ 減半、^ 升八度、_ 降八度、# 升 b 降；8 9 當高音 1 2。其他字元略過——所以圓周率直接貼進來就能唱',
  'jp.play':      '演奏',
  'jp.name':      '簡譜即興',
  'jp.bpm':       '速度',
  'jp.pi':        'π 圓周率',
